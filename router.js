...
const DASHBOARD_PAGES = [
  'student-dashboard', 'tpo-dashboard', 'admin-dashboard', 'coordinator-dashboard', 'faculty-dashboard',
...
const routes = {
  ...
  'coordinator-dashboard': (r,s,sb) => { window.location.hash = 'dept-students'; },
